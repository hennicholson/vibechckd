...
export default function Footer() {
  return (
    <footer className="border-t border-border">
      <div className="max-w-[960px] mx-auto px-6 py-5 flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-0 text-[12px]">
          <Link href="/legal/terms" className="text-text-muted hover:text-text-secondary transition-colors duration-150">Terms</Link>
