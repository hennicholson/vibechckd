    ...
    <div className="max-w-3xl mx-auto px-6 py-8">
      ...
      {items.length === 0 && (
        <div className="text-center py-16">
          ...
          <p className="text-[12px] text-text-muted mt-1">Click "Add project" to get started.</p>
        </div>
      )}
      ...
      <div className="space-y-3">
        {items.map((item, idx) => (
          ...
          >
            ...
            <div className="w-[60px] h-[60px] bg-surface-muted flex-shrink-0 flex items-center justify-center">
            ...
            <div className="flex flex-col gap-0.5 flex-shrink-0">
              <button
                onClick={() => moveUp(idx)}
                disabled={idx === 0}
                className="text-text-muted hover:text-text-primary disabled:opacity-20 disabled:pointer-events-none transition-colors cursor-pointer p-0.5"
                aria-label="Move up"
              >
